"""
Run model-based feedback demo: model output drives feedback type (A/B), full artifact set.

Usage (from repo root or with PYTHONPATH=src):
  python examples/model_feedback_demo/run_demo.py --out-dir demo_out --duration 4
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Model-based feedback demo: full artifact set")
    ...
    print("Model feedback demo: session recorded. Post-processing...", file=sys.stderr)
